...
type
  ...
  public
    ...
    { Métodos }
    function FormatMoeda(AMascara:String; AValor : Double) : String;
    function  Repete(Caractere: shortstring; nCaracteres: integer): string;
    procedure Abort;
    procedure BeginDoc;
    procedure EndDoc(EjectPage: Boolean = True);
    procedure NewLine(ALines: Integer = 1);
    procedure NewPage(APages: Integer = 1);
    procedure Print(AColumn: Integer; AText: string; ALineFeed: Boolean = False); overload;
    procedure Print(ALine, AColumn: Integer; AText: string; ALineFeed: Boolean = False); overload;
    procedure PrintCenter(AColumn: Integer; AText: string; ALineFeed: Boolean = False); overload;
    procedure Replicate(AColumn, ACount: Integer; AChar: Char = '-'; ALineFeed: Boolean = True); overload;
    procedure Replicate(ALine, AColumn, ACount: Integer; AChar: Char = '-'; ALineFeed: Boolean = True); overload;
    procedure Replicate2(AColumn, ACount: Integer; AChar: Char = '='; ALineFeed: Boolean = True); overload;
	procedure Replicate2(ALine, AColumn, ACount: Integer; AChar: Char = '='; ALineFeed: Boolean = True); overload;
    procedure Replicate3(AColumn, ACount: Integer; AChar: Char = '*'; ALineFeed: Boolean = True); overload;
	procedure Replicate3(ALine, AColumn, ACount: Integer; AChar: Char = '*'; ALineFeed: Boolean = True); overload;
    procedure Replicate4(AColumn, ACount: Integer; AChar: Char = '_'; ALineFeed: Boolean = True); overload;
	procedure Replicate4(ALine, AColumn, ACount: Integer; AChar: Char = '_'; ALineFeed: Boolean = True); overload;
  procedure PrintDireita(AColumn: Integer; AText: string; ALineFeed: Boolean = False); overload;
...
function TVDOPrinter.AlinhaC(Texto: String; Tamanho: integer): String;
var
  metade: integer;
begin
  Texto := Trim(Texto);
...
function TVDOPrinter.AlinhaD(Texto: String; Tamanho: Integer): String;
begin
     Texto := Trim(Texto);
...
function TVDOPrinter.AlinhaE(Texto: String; Tamanho: Integer): String;
begin
      Texto := Trim(Texto);
  while length(Texto) < Tamanho do
  begin
...
function TVDOPrinter.FormatMoeda(AMascara: String; AValor: Double): String;
var
  lValor : String;
begin
  lValor := '';
  Result := '';
  lValor := FormatFloat(AMascara,AValor);
  lValor := Repete(' ',Length(AMascara)-Length(lValor))+lValor;
  Result := lValor;
end;
...
procedure TVDOPrinter.Print(AColumn: Integer; AText: string; ALineFeed: Boolean = False);
begin
  case FPrinterType of
    ptCanvas:
      begin
...
procedure TVDOPrinter.PrintCenter(AColumn: Integer; AText: string; ALineFeed: Boolean = False);
var
  Divi1, Divi2, Coluna, Len : Integer;
begin
  Divi1 := AColumn div 2;
  Len := Length(AText);
  Divi2 := Len div 2;
  ...
  Coluna := Divi1 - Divi2;
  Print(Coluna, AText, ALineFeed);
end;

procedure TVDOPrinter.PrintDireita(AColumn: Integer; AText: string;ALineFeed: Boolean);
var
  Divi1, Divi2, Coluna, Len : Integer;
begin
  Divi1 := AColumn div 1;
...
function TVDOPrinter.Repete(Caractere: shortstring; nCaracteres: integer): string;
var
  n : integer;
  CadeiaCar : string;
begin
...
procedure TVDOPrinter.Replicate2(AColumn, ACount: Integer;
   AChar: Char = '='; ALineFeed: Boolean = True);
begin
  Print(AColumn, StringOfChar(AChar, ACount), ALineFeed);
end;
procedure TVDOPrinter.Replicate2(ALine, AColumn, ACount: Integer;
  AChar: Char = '='; ALineFeed: Boolean = True);
begin
  Print(ALine, AColumn, StringOfChar(AChar, ACount), ALineFeed);
end;
...
procedure TVDOPrinter.Replicate3(AColumn, ACount: Integer;
   AChar: Char = '*'; ALineFeed: Boolean = True);
begin
  Print(AColumn, StringOfChar(AChar, ACount), ALineFeed);
end;
procedure TVDOPrinter.Replicate3(ALine, AColumn, ACount: Integer;
  AChar: Char = '*'; ALineFeed: Boolean = True);
begin
  Print(ALine, AColumn, StringOfChar(AChar, ACount), ALineFeed);
end;

procedure TVDOPrinter.Replicate4(AColumn, ACount: Integer;
AChar: Char='_'; ALineFeed: Boolean = True);
begin
    Print(AColumn, StringOfChar(AChar, ACount), ALineFeed);

end;
procedure TVDOPrinter.Replicate4(ALine, AColumn, ACount: Integer;
  AChar: Char = '_'; ALineFeed: Boolean = True);
begin
  Print(ALine, AColumn, StringOfChar(AChar, ACount), ALineFeed);
end;
